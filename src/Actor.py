...
class Actor:
    def __init__(self, world: b2World):
        ...
        self.addBone(world, 'thigh2', 'torso',  angleLow=-b2_pi*0.25, angleHigh=b2_pi*0.5,    size=(0.4, 0.15))
    ...
    def getInputArray(self):
        ...
        rootPos = rootBone.position + Vec2(rootBone.ms_anchor[1]).rotate(rootBone.angle * RadToDeg)
    ...
    def addBone(self, world, name, parentName='', size=(1, 0.2), angle=0, pos=(0, 3), anchor0=-0.95, anchor1=0.95, parentAnchor=1, thisAnchor=0, angleLow=0, angleHigh=0, maxTorque=20, color=(255, 255, 255, 255)):
